...
from stellar_sdk.soroban_types import Uint32, Struct, StructField, Enum, Bytes

secret = "SAAPYAPTTRZMCUZFPG3G66V4ZMHTK4TWA6NS7U4F7Z3IMUD52EK4DDEV"
contract_id = "7ae7d4d8832d11ab5e5f28cd0850de447cdc8c63343809e8beb042d36c5fbf8c"
...
animal = Enum("Cat", None)
user = Struct(
    [
        StructField("name", Bytes(b"Stellar")),
        StructField("age", Uint32(18)),
        StructField("pet", animal),
    ]
)
